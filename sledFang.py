...
def sprayer(domain, user_list, password_list, target_ip, output, bypass, rate_limit, delay):
...
def main():
    ...
    # run the program
    sprayer(domain, users, passwords, target, output, bypass, rate_limit, delay)
